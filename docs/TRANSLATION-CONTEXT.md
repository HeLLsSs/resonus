...
| `Add` |  |
| `Add a LinkPlay speaker by address…` |  |
...
| `Nothing at that address answers as a LinkPlay speaker` |  |
...
| `Spotify is branched` |  |
| `Spotify no longer opens a playlist to an app on its own. Branch your Spotify account on this screen, once.` |  |
...
| `For OLED screens. Only in the dark appearance.` | The line under “Pure black backgrounds”, explaining it |
...
| `The accent Android takes from the wallpaper` | The line under “Use the system colors”, explaining it |
| `Theme` | The screen where the appearance and the accent colour are chosen, and the name of the row that opens it |
